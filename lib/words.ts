// ───────────────────────────────────────────────────────────────────────────
// Список слов из 5 букв (общеупотребительные, без имён собственных).
// Используется и как пул ответов дня, и как словарь для проверки догадок.
// Все слова в нижнем регистре, ровно 5 букв.
// ───────────────────────────────────────────────────────────────────────────
...
export const WORDS: string[] = [
  ...
  "badly", "baker", "basic", "basis", "beach", "began", "begin", "begun",
  ...
  "broad", "broke", "brown", "build", "built", "buyer", "cabin", "cable",
  ...
  "other", "ought", "paint", "panel", "paper", "party", "peace", "phase",
  ...
  "right", "rigid", "river", "rough", "round", "route", "royal", "rural",
  ...
  "sixty", "skill", "sleep", "slide", "small", "smart", "smile", "smoke",
  ...
  "steer", "stern", "stick", "still", "stock", "stone", "stood", "store",
  "storm", "story", "strip", "stuck", "study", "stuff", "style", "sugar",
  "suite", "super", "sweet", "swift", "swing", "sword", "table", "taken",
  ...
  "tried", "tries", "truck", "truly", "trust", "truth", "twice", "twist",
...
/** Множество для быстрой проверки «есть ли такое слово». */
